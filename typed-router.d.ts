...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'auth-confirm-password': RouteRecordInfo<'auth-confirm-password', '/Auth/ConfirmPassword', Record<never, never>, Record<never, never>>,
    ...
    'auth-verify-email': RouteRecordInfo<'auth-verify-email', '/Auth/VerifyEmail', Record<never, never>, Record<never, never>>,
    ...
    'profile-partials-delete-user-form': RouteRecordInfo<'profile-partials-delete-user-form', '/Profile/Partials/DeleteUserForm', Record<never, never>, Record<never, never>>,
    'profile-partials-update-password-form': RouteRecordInfo<'profile-partials-update-password-form', '/Profile/Partials/UpdatePasswordForm', Record<never, never>, Record<never, never>>,
    'profile-partials-update-profile-information-form': RouteRecordInfo<'profile-partials-update-profile-information-form', '/Profile/Partials/UpdateProfileInformationForm', Record<never, never>, Record<never, never>>,
